...
// US States with springs (can be expanded)
const STATES = [
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex gap-10 md:gap-14">
              <div>
                <div className="font-display text-4xl md:text-5xl font-bold text-terracotta">12</div>
                <div className="text-sm text-bark/50 mt-1 font-body">Springs</div>
              </div>
              <div>
                <div className="font-display text-4xl md:text-5xl font-bold text-river">9</div>
