...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://soakmap.com/natural-springs-near-me',
  },
  openGraph: {
    title: content.title,
    description: content.metaDescription,
    type: 'website',
    url: 'https://soakmap.com/natural-springs-near-me',
    siteName: 'SoakMap',
  },
  twitter: {
    ...
    <div className="min-h-screen bg-stone">
      ...
      <main id="main-content" className="pt-8 pb-20">
        ...
        <NearMeHero
          ...
          title={content.h1}
          intro={content.intro}
          springCount={stats.total}
        />

        {/* Geolocation + Results (no type filter - shows all) */}
        <Suspense fallback={<ResultsSkeleton />}>
          <NearMeResults fallbackSprings={featuredSprings.slice(0, 6)} />
        </Suspense>

        {/* Featured Springs Grid - Static SSR content for SEO */}
        <FeaturedSpringsGrid
          springs={featuredSprings}
          title="Featured Natural Springs"
          description="Explore a diverse selection of natural hot springs and swimming holes."
          viewAllHref="/states"
        ...
        <StateQuickLinks
          states={states}
          title="Natural Springs by State"
          description="Find natural springs in your state or explore new destinations."
        />

        {/* City Directory */}
        <CityDirectory
          cities={cities}
          title="Find Natural Springs by City"
          description="Browse natural hot springs and swimming holes near major cities across America."
        />
